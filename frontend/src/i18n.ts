...
const ZH: Dict = {
  ...
  'ext.preset': '预设档案', 'ext.presetHint': '选择预设会把下方所有扩展切换为该组合的状态。',
  'ext.preset.default': '默认集', 'ext.preset.minimal': 'minimal', 'ext.preset.web': 'web', 'ext.preset.debug': 'debug',
...
const EN: Dict = {
  ...
  'ext.preset': 'Presets', 'ext.presetHint': 'A preset switches all extensions below to that combination.',
  'ext.preset.default': 'Default', 'ext.preset.minimal': 'minimal', 'ext.preset.web': 'web', 'ext.preset.debug': 'debug',
